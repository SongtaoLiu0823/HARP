...
"""Modified from your_python_site-packages_path/transformers/models/gemma2/modeling_gemma2.py (4.42.3)"""
import inspect
...
from .configuration_gemma2_drop_qk import Gemma2Config
...
class Gemma2SdpaAttention(Gemma2Attention):
    ...
    def forward(
        ...
        if self.drop_qk:
            ...
            if attention_mask is not None:
                causal_mask = causal_mask[:, :, :, : value_states.shape[-2]]
            if value_states.device.type == "cuda" and causal_mask is not None:
